<template>
  <div class="form_class">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="学校名称" prop="username">
              <el-input v-model="basicFormData.schoolname" disabled> </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="学院" prop="xueyuan">
              <el-select v-model="basicFormData.xueyuan" @change="zhuanyeData">
                <el-option
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="入学年份" prop="ruxueyear">
              <el-select v-model="basicFormData.ruxueyear" style="width: 100%">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="学号" prop="studentId">
              <el-input v-model="basicFormData.studentId" style="width: 100%">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
    ...
    <div style="margin-top: 16px; text-align: right">
      <el-button type="primary" style="width: 100px" @click="submitBasicForm"
        >提交修改</el-button
      >
    </div>
  </div>
...
import { nameTest, idCardTest, phoneTest, emailTest } from "@/utils/tegTest";
import { ElMessage, FormRules } from "element-plus";
import { ref, reactive, onBeforeUnmount } from "vue";
import { editUserBasic } from "@/api/user";
import {
  getXueYuanData,
  getZhuanYeData,
  OptionType,
...
const props = defineProps(["basicFormData"]);

const basicForm = ref<any>();
const contactForm = ref<any>();
const schoolForm = ref<any>();

const { basicFormData } = props;
const resetFormData = props.basicFormData;
...
const rulesForm = reactive<FormRules>({
  ...
  age: [
    { required: false, message: "请输入年龄", trigger: "blur" },
    {
      asyncValidator: (rule, value) => {
        return new Promise((resolve, reject) => {
          if ((value < 1 && value) || (value > 100 && value)) {
            reject("请输入正确的年龄");
          } else {
            resolve();
          }
...
const resetForm = () => {
  basicFormData.value = resetFormData.value;
};
